# dogechia-blockchain-gui/api-react
...
This library provides react hooks on the top of @dogechia-network/api and uses [RTK Query](https://redux-toolkit.js.org/rtk-query/overview) under the hood.
...
- Automatically refresh queries when data changed (using events from Dogechia Blockchain).
...
import { useGetPublicKeysQuery } from '@dogechia-network/api-react';
...
import { store, api } from '@dogechia-network/api-react';
