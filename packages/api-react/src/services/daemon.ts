import { Daemon, optionsForPlotter, defaultsForPlotter, PlotterName } from '@dogechia-network/api';
import type { Plotter, PlotterMap, PlotterApi } from '@dogechia-network/api';
