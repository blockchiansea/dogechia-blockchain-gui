...
import { CAT, DID, Farmer, NFT, Pool, WalletService, WalletType, toBech32m, VC } from '@dogechia-network/api';
import type { NFTInfo, Transaction, Wallet, WalletBalance } from '@dogechia-network/api';
