...
import dogechiaToMojo from '../../utils/dogechiaToMojo';
...
export default function Amount(props: AmountProps) {
  ...
  const isDogechiaCurrency = ['XDG', 'TXDG'].includes(currencyCode);
  const mojo = isDogechiaCurrency ? dogechiaToMojo(correctedValue) : catToMojo(correctedValue);
    ...
    <FormControl variant={variant} fullWidth={fullWidth}>
      <TextField
        ...
        InputProps={{
          ...
          inputProps: {
            decimalScale: isDogechiaCurrency ? 12 : 3,
            'data-testid': dataTestid,
          },
