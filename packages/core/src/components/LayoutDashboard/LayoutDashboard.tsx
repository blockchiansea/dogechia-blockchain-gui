import { useGetLoggedInFingerprintQuery, useGetKeyQuery, useFingerprintSettings } from '@dogechia-network/api-react';
import { Exit as ExitIcon } from '@dogechia-network/icons';
