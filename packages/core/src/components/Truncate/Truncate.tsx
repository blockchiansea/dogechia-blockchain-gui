...
export function truncateValue(children: string, opts: TruncateValueOptions): string {
  const {
    ...
    rightLength = 4,
    splitSeparator = ':',
    prefixes = ['nft1', 'txdg1', 'xdg1', 'did:dogechia:1', '0x'],
  } = opts;
  ...
  if (stringValue === 'did:dogechia:19qf3g9876t0rkq7tfdkc28cxfy424yzanea29rkzylq89kped9hq3q7wd2') {
    return 'Dogechia Network';
  }
