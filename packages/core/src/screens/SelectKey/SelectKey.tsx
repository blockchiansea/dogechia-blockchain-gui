import type { KeyData } from '@dogechia-network/api';
import {
  usePrefs,
...
import { DogechiaBlack, Coins } from '@dogechia-network/icons';
        ...
        {isLoadingPublicKeys ? (
          ...
          <>
            ...
            <Flex alignItems="center" flexDirection="column">
              ...
              >
                <Trans>Create a new wallet key to get started with Dogechia.</Trans>
              </Typography>
              <Button
