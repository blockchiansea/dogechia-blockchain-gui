import { PassphrasePromptReason } from '@dogechia-network/api';
import { useUnlockKeyringMutation, useGetKeyringStatusQuery } from '@dogechia-network/api-react';
import { Button, Flex, TooltipIcon, useShowError, Suspender, ButtonLoading, Form, TextField } from '@dogechia-network/core';
