...
import WalletConnectProvider, { WalletConnectDogechiaProjectId } from '../walletConnect/WalletConnectProvider';
                      ...
                      <Suspense fallback={<LayoutLoading />}>
                        <OffersProvider>
                          <NotificationsProvider>
                            <WalletConnectProvider projectId={WalletConnectDogechiaProjectId}>
