import { Button, Flex, Logo, Card, useMode, Mode } from '@dogechia-network/core';
import { Farming as FarmingIcon } from '@dogechia-network/icons';
                  ...
                  <Flex flexDirection="column" gap={1.5} flexGrow={1}>
                    <Flex gap={1} alignItems="center">
                      ...
                      <Typography variant="body2">
                        <Trans>Store and Send XDG</Trans>
                      </Typography>
                    </Flex>
                    <Flex gap={1} alignItems="center">
                      <StyledCheckIcon color="primary" />
