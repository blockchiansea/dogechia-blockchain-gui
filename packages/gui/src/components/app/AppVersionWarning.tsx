import { Button, Flex } from '@dogechia-network/core';
        ...
        <DialogContent>
          <Flex flexDirection="column" gap={1}>
            <Typography variant="body2" color="textSecondary">
              <Trans>
                The Dogechia application and its services are using different versions. Some functionality may not be behave
                properly as a result.
                <br />
                <br />
                Dogechia services version: {backV}
                <br />
                Dogechia application version: {guiV}
                <br />
                <br />
                It is recommended that you quit the Dogechia application and stop all Dogechia services.
              </Trans>
            </Typography>
          </Flex>
        </DialogContent>
