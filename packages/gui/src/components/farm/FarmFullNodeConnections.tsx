import type { Connection } from '@dogechia-network/api';
import { ServiceName } from '@dogechia-network/api';
import { useGetFarmerFullNodeConnectionsQuery, useService } from '@dogechia-network/api-react';
import { Table, Card, FormatBytes, FormatConnectionStatus } from '@dogechia-network/core';
