import { fromBech32m } from '@dogechia-network/api';
import { useSetRewardTargetsMutation, useGetRewardTargetsQuery } from '@dogechia-network/api-react';
import { Button, Flex, Form, TextField, Loading } from '@dogechia-network/core';
              ...
              <>
                ...
                <Typography variant="body2" color="textSecondary">
                  <Trans>
                    ...
                    and the 0.25XDG reward for pooling plots.
                  </Trans>
                </Typography>
              </>
            )}
