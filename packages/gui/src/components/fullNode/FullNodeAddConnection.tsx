import { useOpenFullNodeConnectionMutation } from '@dogechia-network/api-react';
import { Button, ButtonLoading, DialogActions, Flex, Form, TextField, useShowError } from '@dogechia-network/core';
