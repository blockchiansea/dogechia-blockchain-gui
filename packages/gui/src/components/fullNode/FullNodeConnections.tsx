import { Connection } from '@dogechia-network/api';
import { useGetFullNodeConnectionsQuery } from '@dogechia-network/api-react';
import { Card, FormatBytes, FormatLargeNumber, IconButton, Loading, Table, useOpenDialog } from '@dogechia-network/core';
