...
import { useGetDIDsQuery, useGetNFTWallets, useGetNFTWalletsWithDIDsQuery } from '@dogechia-network/api-react';
import { DropdownActions, MenuItem } from '@dogechia-network/core';
import { NFTsSmall as NFTsSmallIcon } from '@dogechia-network/icons';
