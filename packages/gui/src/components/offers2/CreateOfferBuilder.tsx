...
import { useGetWalletsQuery, useCreateOfferForIdsMutation } from '@dogechia-network/api-react';
import { Flex, ButtonLoading, useOpenDialog, Loading } from '@dogechia-network/core';
