...
import { useGetOfferSummaryMutation } from '@dogechia-network/api-react';
import { Dropzone, Flex, useSerializedNavigationState, useShowError } from '@dogechia-network/core';
