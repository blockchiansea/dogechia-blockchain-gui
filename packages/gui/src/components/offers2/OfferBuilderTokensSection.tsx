...
import { useGetWalletsQuery } from '@dogechia-network/api-react';
import { Flex, Loading, catToMojo, mojoToCATLocaleString } from '@dogechia-network/core';
import { Tokens } from '@dogechia-network/icons';
...
export default function OfferBuilderTokensSection(props: OfferBuilderTokensSectionProps) {
  ...
  return (
    <OfferBuilderSection
      ...
      subtitle={<Trans>Dogechia Asset Tokens (CATs) are tokens built on top of XDG</Trans>}
