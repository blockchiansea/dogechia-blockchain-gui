...
import { useGetOfferSummaryMutation, useCheckOfferValidityMutation } from '@dogechia-network/api-react';
import { isValidURL } from '@dogechia-network/core';
...
const log = debug('dogechia-gui:OfferProvider');
