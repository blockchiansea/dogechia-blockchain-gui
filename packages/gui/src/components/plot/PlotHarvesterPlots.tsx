import { type Plot } from '@dogechia-network/api';
import { useGetHarvesterPlotsValidQuery, useGetHarvesterQuery } from '@dogechia-network/api-react';
import { Address, TableControlled, Flex, FormatBytes, Tooltip, StateColor } from '@dogechia-network/core';
