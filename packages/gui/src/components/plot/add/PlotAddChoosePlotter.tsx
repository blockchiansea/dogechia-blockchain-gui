import { defaultPlotter, PlotterName } from '@dogechia-network/api';
import type { Plotter, PlotterMap } from '@dogechia-network/api';
import { useGetPlottersQuery } from '@dogechia-network/api-react';
import { CardStep, Select, StateColor } from '@dogechia-network/core';
...
export default function PlotAddChoosePlotter(props: Props) {
  ...
  function getDisplayablePlotters(p: PlotterMap<PlotterName, Plotter>): PlotterName[] {
    ...
    displayablePlotters.sort((a, b) => (a === PlotterName.DOGECHIAPOS ? -1 : a.localeCompare(b)));
    ...
    <CardStep step={step} title={<Trans>Choose Plotter</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
          ...
          the default Dogechia Proof of Space plotter. If unsure, use the default Dogechia Proof of Space plotter.
        </Trans>
      </Typography>
