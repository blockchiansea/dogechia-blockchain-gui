import { defaultPlotter, toBech32m, fromBech32m } from '@dogechia-network/api';
import { useStartPlottingMutation, useCreateNewPoolWalletMutation } from '@dogechia-network/api-react';
import { Back, useShowError, ButtonLoading, Flex, Form } from '@dogechia-network/core';
...
export default function PlotAddForm(props: Props) {
  ...
  const methods = useForm<FormData>({
    defaultValues: defaultsForPlotter(PlotterName.DOGECHIAPOS),
  });
