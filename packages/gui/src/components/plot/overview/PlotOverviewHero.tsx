import { useRefreshPlotsMutation } from '@dogechia-network/api-react';
import { Button, CardHero, Flex, Link, useOpenDialog } from '@dogechia-network/core';
import { Plots } from '@dogechia-network/icons';
