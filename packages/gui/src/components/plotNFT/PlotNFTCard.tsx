import { useDeleteUnconfirmedTransactionsMutation } from '@dogechia-network/api-react';
import {
  Button,
  TooltipTypography,
  Flex,
...
import { Plot as PlotIcon } from '@dogechia-network/icons';
...
export default function PlotNFTCard(props: Props) {
  ...
  const rows = [
    ...
    isSelfPooling && {
      ...
      value: <UnitFormat value={mojoToDogechiaLocaleString(balance)} state={State.SUCCESS} />,
    },
    {
      key: 'plotsCount',
