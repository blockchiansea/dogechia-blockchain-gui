import { useGetPlotNFTsQuery, usePwSelfPoolMutation, usePwJoinPoolMutation } from '@dogechia-network/api-react';
import { Flex, State, Loading, StateTypography } from '@dogechia-network/core';
