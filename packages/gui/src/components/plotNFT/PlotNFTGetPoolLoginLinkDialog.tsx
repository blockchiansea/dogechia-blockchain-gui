import type { PlotNFT, PlotNFTExternal } from '@dogechia-network/api';
import { useGetPoolLoginLinkQuery } from '@dogechia-network/api-react';
import { Button, CopyToClipboard, Flex, Link, Loading } from '@dogechia-network/core';
          ...
          {isLoading ? (
            ...
            <Flex flexDirection="column" gap={2}>
              ...
              <Typography variant="body2" color="textSecondary">
                ...
                <Link
                  target="_blank"
                  href="https://github.com/Dogechia-Network/pool-reference/blob/main/SPECIFICATION.md#get-login"
                  noWrap
                >
