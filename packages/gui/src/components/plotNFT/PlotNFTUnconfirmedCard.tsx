import type { UnconfirmedPlotNFT } from '@dogechia-network/api';
import { useGetTransactionQuery } from '@dogechia-network/api-react';
import { Flex, Link, Loading } from '@dogechia-network/core';
