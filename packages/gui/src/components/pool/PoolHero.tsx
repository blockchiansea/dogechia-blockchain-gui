import { Button, CardHero } from '@dogechia-network/core';
import { Pooling } from '@dogechia-network/icons';
      ...
      <Grid xs={12} md={6} lg={5} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>Smooth out your XDG farming rewards by joining a pool.</Trans>
          </Typography>
