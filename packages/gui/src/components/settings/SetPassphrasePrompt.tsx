import { useGetKeyringStatusQuery, useSetKeyringPassphraseMutation } from '@dogechia-network/api-react';
import {
  AlertDialog,
  Button,
  DialogActions,
        ...
        <DialogContent>
          ...
          {!!canSavePassphrase && (
            <Box display="flex" alignItems="center">
              ...
              />
              <Tooltip
                title={t`Your passphrase can be stored in your system's secure credential store. Dogechia will be able to access your keys without prompting for your passphrase.`}
              >
