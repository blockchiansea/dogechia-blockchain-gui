...
import { Flex, SettingsHR, SettingsSection, SettingsText } from '@dogechia-network/core';
...
export default function SettingsCustody() {
  ...
  return (
    <Grid container style={{ maxWidth: '624px' }} gap={3}>
      ...
      <Box>
        <SettingsSection>
          <Trans>Default claw back time for outgoing XDG transactions</Trans>
        </SettingsSection>

        <SettingsText>
          <Trans>Set a default time frame for all outbound XDG transactions.</Trans>
        </SettingsText>
