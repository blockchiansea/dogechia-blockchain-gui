import { Flex, SettingsHR, SettingsSection, SettingsTitle, SettingsText } from '@dogechia-network/core';
    ...
    <Grid container style={{ maxWidth: '624px' }} gap={3}>
      <Grid item>
        <Flex flexDirection="column" gap={1}>
          ...
          <SettingsText>
            <Trans>
              DataLayer enables rich data to be stored on mirrored databases that can be verified using the Dogechia
              Blockchain.
            </Trans>
          </SettingsText>
        </Flex>
      ...
      <Grid container>
        ...
        <Grid item container style={{ width: '400px' }} gap={2}>
          ...
          <FormHelperText>
            <Trans>Changes will take effect the next time Dogechia is started.</Trans>
          </FormHelperText>
        </Grid>
      </Grid>
