import { SyncingStatus } from '@dogechia-network/api';
import { useExtendDerivationIndexMutation, useGetCurrentDerivationIndexQuery } from '@dogechia-network/api-react';
import { AlertDialog, ButtonLoading, Flex, Form, TextField, useOpenDialog } from '@dogechia-network/core';
import { useWalletState } from '@dogechia-network/wallets';
