import { useGetKeysQuery, useGetLoggedInFingerprintQuery } from '@dogechia-network/api-react';
import {
  ButtonLoading,
  DialogActions,
  Flex,
...
import HeroImage from './images/walletConnectToDogechia.svg';
...
export default function WalletConnectAddConnectionDialog(props: WalletConnectAddConnectionDialogProps) {
  ...
  const mainnet = useCurrencyCode() === 'XDG';
