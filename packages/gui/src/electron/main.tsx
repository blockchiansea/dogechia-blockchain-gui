...
import { NFTInfo } from '@dogechia-network/api';
...
import AppIcon from '../assets/img/dogechia64x64.png';
import About from '../components/about/About';
import { i18n } from '../config/locales';
import dogechiaEnvironment from '../util/dogechiaEnvironment';
...
// Set the userData directory to its location within DOGECHIA_ROOT/gui
setUserDataDir();
...
const ensureCorrectEnvironment = () => {
  ...
  if (!dogechiaEnvironment.guessPackaged() && !('VIRTUAL_ENV' in process.env)) {
    app.quit();
    return false;
  }
...
if (ensureSingleInstance() && ensureCorrectEnvironment()) {
  ...
  const createWindow = async () => {
    if (manageDaemonLifetime(NET)) {
      dogechiaEnvironment.startDogechiaDaemon();
    }
...
function getMenuTemplate() {
      ...
      submenu: [
        {
          ...
          click: () => {
            openExternal('https://github.com/Dogechia-Network/dogechia-blockchain/wiki');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Frequently Asked Questions' }),
          click: () => {
            openExternal('https://github.com/Dogechia-Network/dogechia-blockchain/wiki/FAQ');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Release Notes' }),
          click: () => {
            openExternal('https://github.com/Dogechia-Network/dogechia-blockchain/releases');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Contribute on GitHub' }),
          click: () => {
            openExternal('https://github.com/Dogechia-Network/dogechia-blockchain/blob/main/CONTRIBUTING.md');
          },
        },
        {
          type: 'separator',
        },
        {
          ...
          click: () => {
            openExternal('https://github.com/Dogechia-Network/dogechia-blockchain/issues');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Chat on Discord' }),
          click: () => {
            openExternal('https://discord.gg/dogechia');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Follow on Twitter' }),
          click: () => {
            openExternal('https://twitter.com/dogechia_project');
          },
        },
      ],
    },
  ...
  if (process.platform === 'darwin') {
    // Dogechia Blockchain menu (Mac)
    template.unshift({
      label: i18n._(/* i18n */ { id: 'Dogechia' }),
      submenu: [
        {
          label: i18n._(/* i18n */ { id: 'About Dogechia Blockchain' }),
          click: () => {
            openAbout();
          },
        },
