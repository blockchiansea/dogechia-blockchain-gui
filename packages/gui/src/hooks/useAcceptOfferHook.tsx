import type { OfferSummaryRecord, Wallet } from '@dogechia-network/api';
import { useTakeOfferMutation } from '@dogechia-network/api-react';
import { AlertDialog, dogechiaToMojo, useOpenDialog, useShowError } from '@dogechia-network/core';
...
export default function useAcceptOfferHook(): [AcceptOfferHook] {
  ...
  async function acceptOffer(
    ...
    const feeInMojos: BigNumber = fee ? dogechiaToMojo(fee) : new BigNumber(0);
