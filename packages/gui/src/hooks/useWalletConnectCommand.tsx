import api, { store, useGetLoggedInFingerprintQuery, useLogInMutation } from '@dogechia-network/api-react';
import { useOpenDialog } from '@dogechia-network/core';
...
const log = debug('dogechia-gui:walletConnectCommand');
