import { OfferCoinOfInterest, OfferSummaryRecord } from '@dogechia-network/api';
import { useGetOffersCountQuery, useGetAllOffersQuery } from '@dogechia-network/api-react';
