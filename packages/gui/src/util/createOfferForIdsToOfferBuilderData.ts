import { toBech32m, WalletType } from '@dogechia-network/api';
import { mojoToDogechia, mojoToCAT } from '@dogechia-network/core';
      ...
      if (asset) {
        switch (asset.walletType) {
          case WalletType.STANDARD_WALLET:
            section.xdg.push({ amount: mojoToDogechia(numericValue.abs()).toFixed() });
            break;
          case WalletType.CAT:
