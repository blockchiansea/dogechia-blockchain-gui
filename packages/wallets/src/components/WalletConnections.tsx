import { Connection, ServiceConnectionName } from '@dogechia-network/api';
import { useGetWalletConnectionsQuery } from '@dogechia-network/api-react';
import { Card, FormatBytes, Loading, Table } from '@dogechia-network/core';
