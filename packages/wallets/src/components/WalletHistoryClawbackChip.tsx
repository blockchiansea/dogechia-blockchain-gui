import { TransactionType } from '@dogechia-network/api';
import type { Transaction } from '@dogechia-network/api';
import { useGetAutoClaimQuery } from '@dogechia-network/api-react';
import { useTrans, Button } from '@dogechia-network/core';
