import { useGetCurrentAddressQuery, useGetNextAddressMutation } from '@dogechia-network/api-react';
import { Flex, Loading, truncateValue, useColorModeValue } from '@dogechia-network/core';
import { Reload } from '@dogechia-network/icons';
