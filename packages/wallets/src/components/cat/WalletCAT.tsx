...
import { useSetCATNameMutation, useGetCatListQuery } from '@dogechia-network/api-react';
import { Flex, Loading, MenuItem, useOpenDialog } from '@dogechia-network/core';
import { Offers as OffersIcon } from '@dogechia-network/icons';
