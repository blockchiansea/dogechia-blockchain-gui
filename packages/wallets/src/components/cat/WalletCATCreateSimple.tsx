import type { CATToken } from '@dogechia-network/api';
import { SyncingStatus } from '@dogechia-network/api';
import { useGetWalletsQuery, useAddCATTokenMutation, useGetCatListQuery } from '@dogechia-network/api-react';
import { Back, Flex, Loading, useShowError } from '@dogechia-network/core';
