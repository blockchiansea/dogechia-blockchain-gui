...
import icon from '../../assets/img/dogechia_circle.svg';
  ...
  return (
    <html>
      ...
      <body>
        ...
        <Spacer />
        <div className="copyright">Copyright (c) 2021 DogeChia Network</div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
            <tr>
        ...
        <BugReport
          href="https://github.com/DogeChia-Network/dogechia-blockchain/issues"
          target="_blank"
        >
          Report an issue
        </BugReport>
