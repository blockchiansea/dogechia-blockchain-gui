...
const IncompleteCard = (props) => {
  ...
  function submit() {
    ...
    const dogechiaper_input = ip_parsed.limit;
    ...
    const dogechiaper_value = Number.parseInt(Number(dogechiaper_input));
        ...
        <Grid item xs={12}>
          <Box display="flex">
            ...
            <Box flexGrow={1}>
              <Typography variant="subtitle1">
                <Trans>
                  Spending Limit (dogechia per interval):{' '}
                  {mojo_to_dogechia_string(limit)}
                </Trans>
              </Typography>
            </Box>
          </Box>
