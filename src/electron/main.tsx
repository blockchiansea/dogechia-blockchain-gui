...
import dogechiaConfig from '../util/config';
...
if (!handleSquirrelEvent()) {
  ...
  if (ensureSingleInstance() && ensureCorrectEnvironment()) {
    ...
    dogechiaConfig.loadConfig('mainnet');
    ...
    const createWindow = () => {
      ...
      if (!dogechiaConfig.manageDaemonLifetime()) {
      ...
      mainWindow.on('close', (e) => {
        ...
        if (decidedToClose || !dogechiaConfig.manageDaemonLifetime()) {
          return;
        }
        e.preventDefault();
        if (!isClosing) {
        ...
        submenu: [
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/DogeChia/doge-chia/wiki',
              );
            },
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/DogeChia/doge-chia/wiki/FAQ',
              );
            },
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/DogeChia/doge-chia/releases',
              );
            },
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/DogeChia/doge-chia/blob/main/CONTRIBUTING.md',
              );
            },
          },
          {
          ...
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/DogeChia/doge-chia/issues',
              );
            },
          },
          {
          ...
          },
          {
            ...
            click: () => {
              openExternal('https://twitter.com/dogechia');
            },
          },
        ],
      },
