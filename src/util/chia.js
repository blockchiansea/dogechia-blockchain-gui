...
export const chia_formatter = (value, unit) => new DogeChia(value, unit);
...
export const mojo_to_dogechia = (mojo) => {
  return chia_formatter(Number.parseInt(mojo), 'mojo').to('dogechia').value();
};

export const dogechia_to_mojo = (dogechia) => {
  return chia_formatter(Number.parseFloat(Number(dogechia)), 'dogechia')
    .to('mojo')
    .value();
};

export const mojo_to_dogechia_string = (mojo) => {
  return chia_formatter(Number(mojo), 'mojo').to('dogechia').toString();
};
